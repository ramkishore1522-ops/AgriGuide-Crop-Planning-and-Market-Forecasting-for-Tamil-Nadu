...
Traditional time-series models like Autoregressive Integrated Moving Average (ARIMA) \cite{box1970time} effectively capture linear trends and seasonality but fail to account for exogenous shocks and non-linear climate interactions. Conversely, modern machine learning algorithms such as Random Forests \cite{breiman2001random} and XGBoost \cite{chen2016xgboost} excel at non-linear mappings but often struggle with long-term extrapolation of non-stationary trends. 
