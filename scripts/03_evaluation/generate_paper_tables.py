...
def generate_all_tables() -> None:
        ...
        [
            {
                ...
                "Records": "~2.1M",
                "Period": "2015–2024",
                "Granularity": "Daily, State/District",
                "Variables": "commodity, price, state",
            },
            {
                "Source": "Rainfall (State)",
                "Records": "~300K",
                "Period": "2015–2024",
                "Granularity": "Daily, State",
                "Variables": "actual, deviation",
            },
            {
                "Source": "Rainfall (District)",
                "Records": "~5.6M",
                "Period": "2015–2024",
                "Granularity": "Daily, District",
                "Variables": "actual, deviation",
            },
            {
                ...
                "Records": "~30K",
                "Period": "2012–2023",
                "Granularity": "Annual, State",
                "Variables": "cost, revenue, yield",
            },
            {
                "Source": "MSP",
                "Records": "~600",
                "Period": "1966–2024",
                "Granularity": "Annual",
                "Variables": "crop, min\\_support\\_price",
            },
            {
                "Source": "Groundwater",
                "Records": "~1.4M",
                "Period": "2015–2024",
                "Granularity": "Quarterly, District",
                "Variables": "water\\_level",
            },
            {
    ...
    print(
        f"  Total tables: {sum(1 for line in latex_output if '\\begin{table}' in line)}"
    )
